...
// ========================================================
  ...
  if (!state.started) {
    ...
    const textoTiempo = `Tiempo: ${String(minutos).padStart(2, "0")}:${String(segundos).padStart(2, "0")}`;
    ...
    if (elTiempo && elTiempo.textContent !== textoTiempo) {
      elTiempo.textContent = textoTiempo;
    }
  }}