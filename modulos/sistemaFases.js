...
export function triggerJefeFinalBattle() {
  ...
  state.estadisticasPartida.palabrasJefe = poolExamenFinal.length;
  state.estadisticasPartida.frasesJefe = Math.max(0, poolFinalArray.length - poolExamenFinal.length);
